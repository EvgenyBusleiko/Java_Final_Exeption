...
public class main {
    ...
    // Происходит запуск приложения
        ...
        public static void main(String[] args) {
            ...
            WriteToFile writeFile = new WriteToFile(); // Создается объект класса WriteFile
            ...
            writeFile.writeData(String.valueOf(sb), filePath); // Вызывается метод класса WriteToFile для записи в файл
